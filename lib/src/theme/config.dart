...
double get BUTTON_HEIGHT => PizzacornThemeConfig.buttonHeight; 
double get FIELD_HEIGHT => PizzacornThemeConfig.fieldHeight; 
...
/// Función para configurar EXCLUSIVAMENTE los colores al inicio de la app.
...
/// Función para configurar EXCLUSIVAMENTE el layout y dimensiones.
void ConfigurePizzacornLayout({
  double? radius,
  double? webSize,
  double? buttonHeight,
  double? fieldHeight,
  ...
  if (buttonHeight != null) PizzacornThemeConfig.buttonHeight = buttonHeight;
  if (fieldHeight != null) PizzacornThemeConfig.fieldHeight = fieldHeight;
